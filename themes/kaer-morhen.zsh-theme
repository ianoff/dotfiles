# Kaer Morhen - a varient on Bullet Train
...
#A string contained in your local mac's name
#MY_MAC_NAME="Ians-MBP-2017"#
...
context() {
  ...
  [[ "$user" != "$BULLETTRAIN_CONTEXT_DEFAULT_USER" || -n "$BULLETTRAIN_IS_SSH_CLIENT" ]] && echo -n "${user}$hn"
}
